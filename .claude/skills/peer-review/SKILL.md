...
name: peer-review
description: |
  DE: Strukturierte Manuskript- und Antrags-Review mit checklistenbasierter Bewertung. Nutze fuer formale Peer-Reviews mit Methoden-Assessment, statistischer Validitaet, Berichterstattungsstandards (CONSORT, STROBE; fuer DACH siehe dach_reporting_standards.md) und konstruktivem Feedback. Geeignet fuer Begutachtung fremder Manuskripte und fuer Selbstreview vor Abgabe. Fuer Evidenzqualitaetsbewertung nutze scientific-critical-thinking.
  EN: Structured manuscript/grant review with checklist-based evaluation. Use when writing formal peer reviews with specific criteria methodology assessment, statistical validity, reporting standards compliance (CONSORT, STROBE; for DACH see dach_reporting_standards.md), and constructive feedback. Suitable for reviewing others' manuscripts and self-review before submission. For evidence-quality evaluation use scientific-critical-thinking.
