...
description: |
  DE: Systematische Bewertung wissenschaftlicher Arbeiten mit dem ScholarEval-Framework: strukturiertes Assessment der Forschungsqualitaet (Problemformulierung, Methodik, Analyse, Schreibqualitaet) mit quantitativem Scoring und konkretem Feedback. Geeignet fuer Selbst-Audit eigener Bachelorarbeitskapitel vor der Abgabe.
  EN: Systematically evaluate scholarly work using the ScholarEval framework, providing structured assessment across research quality dimensions including problem formulation, methodology, analysis, and writing with quantitative scoring and actionable feedback. Useful for self-auditing own bachelor thesis chapters before submission.
license: MIT license
metadata:
