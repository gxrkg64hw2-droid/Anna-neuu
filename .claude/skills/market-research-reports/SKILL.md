...
description: |
  DE: Umfassende Marktforschungsberichte im Stil von Top-Beratungen (McKinsey, BCG, Gartner) mit professioneller LaTeX-Formatierung, integrierter Datenbeschaffung via research-lookup und multi-Framework-Analyse: Porter Five Forces, PESTLE, SWOT, TAM/SAM/SOM, BCG-Matrix. Geeignet fuer Marketing- und Wirtschafts-Bachelorarbeiten mit Marktanalyse-Kapitel.
  EN: Generate comprehensive market research reports (50+ pages) in the style of top consulting firms (McKinsey, BCG, Gartner). Features professional LaTeX formatting, deep integration with research-lookup for data gathering, and multi-framework strategic analysis including Porter Five Forces, PESTLE, SWOT, TAM/SAM/SOM, and BCG Matrix. Suitable for marketing/business bachelor theses with market-analysis chapters.
...
python skills/generate-image/scripts/ \
...
- ****: Generate all diagrams, charts, and visualizations
...
Generate 2 supporting visuals using .
```
