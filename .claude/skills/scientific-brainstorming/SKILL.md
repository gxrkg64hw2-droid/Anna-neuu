...
description: |
  DE: Kreative Forschungsideation und Exploration. Nutze fuer offene Brainstorming-Sitzungen, Erkundung interdisziplinaerer Verknuepfungen, Hinterfragen von Annahmen oder Identifikation von Forschungsluecken. Geeignet fuer fruehe Phasen der Forschungsfrageentwicklung, wenn noch keine konkreten Beobachtungen vorliegen. Fuer Hypothesen aus Daten nutze hypothesis-generation.
  EN: Creative research ideation and exploration. Use for open-ended brainstorming sessions, exploring interdisciplinary connections, challenging assumptions, or identifying research gaps. Best for early-stage research planning when you do not have specific observations yet. For formulating testable hypotheses from data use hypothesis-generation.
license: MIT license
metadata:
