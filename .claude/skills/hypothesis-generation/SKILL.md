...
description: |
  DE: Strukturierte Hypothesenformulierung aus Beobachtungen. Nutze, wenn du aus experimentellen Beobachtungen oder Daten testbare Hypothesen mit Vorhersagen ableiten, Mechanismen vorschlagen oder Experimente zu deren Test entwerfen willst. Folgt der wissenschaftlichen Methode. Fuer offene Ideenfindung nutze scientific-brainstorming.
  EN: Structured hypothesis formulation from observations. Use when you have experimental observations or data and need to formulate testable hypotheses with predictions, propose mechanisms, and design experiments to test them. Follows scientific method framework. For open-ended ideation use scientific-brainstorming.
