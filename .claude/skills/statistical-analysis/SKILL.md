...
description: |
  DE: Gefuehrte statistische Analyse mit Testauswahl und Reporting. Nutze, wenn du Hilfe bei der Auswahl geeigneter Tests, Pruefung von Voraussetzungen, Power-Analyse und APA-konformer Ergebnisdarstellung brauchst. Geeignet fuer empirische Methodik- und Ergebniskapitel. DACH-Reporting (Komma als Dezimaltrennzeichen, Mayring qualitativ) siehe dach_reporting_standards.md.
  EN: Guided statistical analysis with test selection and reporting. Use when you need help choosing appropriate tests for your data, assumption checking, power analysis, and APA-formatted results. Best for empirical methodology and results chapters. For DACH-specific reporting standards (German decimal comma, Mayring qualitative content analysis) see dach_reporting_standards.md.
license: MIT license
metadata:
