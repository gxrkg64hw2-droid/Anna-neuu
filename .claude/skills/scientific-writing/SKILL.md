...
description: |
  DE: Wissenschaftliches Schreiben fuer Bachelorarbeiten und Manuskripte. Nutze diese Skill, wenn du wissenschaftliche Prosa in Fliesstext schreibst (niemals Stichpunkte). Zwei-stufiger Prozess: zuerst Outline mit Kernaussagen, dann Umsetzung in Fliessprosa. IMRAD-Struktur, Zitierstile (APA-DE, Harvard, Deutsche Zitierweise, DIN 1505), Tabellen und Abbildungen, Berichterstattungsstandards. Aktiviere zusaetzlich bachelorarbeit-arbeitsweise, wenn an einer Bachelorarbeit gearbeitet wird.
  EN: Scientific writing for thesis chapters and manuscripts. Write scientific manuscripts in flowing paragraphs (never bullet points). Two-stage process with (1) section outlines with key points and (2) conversion to flowing prose. IMRAD structure, citation styles (APA, AMA, Vancouver, plus DACH-specific via dach_zitierweisen.md), figures/tables, reporting guidelines. Combine with bachelorarbeit-arbeitsweise when working on a Bachelor thesis.
