...
description: |
  DE: Meta-Skill fuer publikationsfertige Abbildungen. Nutze beim Erstellen von Journal- oder Thesis-Abbildungen mit Multi-Panel-Layouts, Signifikanz-Annotationen, Fehlerbalken, farbblind-sicheren Paletten und journal-spezifischer Formatierung. Orchestriert matplotlib/seaborn/plotly mit Publikationsstilen. Fuer schnelle Exploration nutze seaborn oder plotly direkt.
  EN: Meta-skill for publication-ready figures. Use when creating journal or thesis figures requiring multi-panel layouts, significance annotations, error bars, colorblind-safe palettes, and specific journal formatting. Orchestrates matplotlib/seaborn/plotly with publication styles. For quick exploration use seaborn or plotly directly.
license: MIT license
metadata:
