...
description: |
  DE: Systematische Literaturrecherche ueber mehrere Fachdatenbanken (PubMed, arXiv, bioRxiv, Semantic Scholar, OpenAlex; fuer DACH-BWL/Marketing/Wirtschaft zusaetzlich GBV, DBIS, wiso, JSTOR, Beck-Online). Nutze fuer Theoretischer-Rahmen-Kapitel, Meta-Analysen oder breite Forschungssynthese. Erstellt formatierte Markdown-Dokumente und PDFs mit verifizierten Zitationen. DACH-Zitierstile siehe dach_zitierweisen.md.
  EN: Conduct comprehensive, systematic literature reviews using multiple academic databases (PubMed, arXiv, bioRxiv, Semantic Scholar, OpenAlex; for DACH-context business/marketing also GBV, DBIS, wiso, JSTOR, Beck-Online). Creates professionally formatted markdown documents and PDFs with verified citations. For DACH citation styles consult dach_zitierweisen.md.
