...
description: |
  DE: Wissenschaftliche Aussagen und Evidenzqualitaet bewerten. Nutze fuer die Beurteilung von Studiendesign, Bias-Identifikation, Confounder-Analyse und Anwendung von Evidenzgraduierungsrahmen (GRADE, Cochrane Risk of Bias). Geeignet fuer Diskussions- und Limitationskapitel. Fuer formale Peer-Review-Texte siehe peer-review.
  EN: Evaluate scientific claims and evidence quality. Use for assessing experimental design validity, identifying biases and confounders, applying evidence grading frameworks (GRADE, Cochrane Risk of Bias), or teaching critical analysis. Best for discussion and limitations chapters. For formal peer-review writing use peer-review.
